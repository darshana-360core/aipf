    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Roi Release Report</h4>
            </div>
        </div>
          <div class="m-t-30">
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs member-tab" role="tablist">
                            <li role="presentation" class="active"><a href="#all_members" aria-controls="all_members"
                                    role="tab" data-toggle="tab">Roi Release Report</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="all_members">
                                <div class="search-form export-form">
                                    <form action="{{route('roiReleaseReport')}}" method="post" class="mb-0">
                                        @csrf
                                        <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                <select name="wtype" class="form-control">
                                                    ...
                                                    <option value="static" @if(isset($data['wtype'])) @if($data['wtype'] == 'static') selected @endif @endif>Static</option>
                                                    <option value="dynamic" @if(isset($data['wtype'])) @if($data['wtype'] == 'dynamic') selected @endif @endif>Dynamic</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                    ...
                                                    <table class="table no-wrap user-table mb-0">
                                                        <thead class="table-light">
                                                            <tr>
                                                                ...
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">Start Date</th>
                                                                <th scope="col" class="border-0 fs-4 font-weight-medium">End Date</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach($data['data']['data'] as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    <td><span>{{date('d-m-Y H:i', strtotime($value['start_datetime']))}}</span></td>
                                                                    <td><span>{{date('d-m-Y H:i', strtotime($value['end_datetime']))}}</span></td>
                                                                </tr>
                                                                @php
                                                                    $total+=$value['amount'];
                                                                @endphp
