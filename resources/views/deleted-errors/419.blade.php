...
@section('content')
              <section class="relative py-24 overflow-hidden md:w-1/3 mx-auto">
                <div class="container px-4 mx-auto relative">
                    <h3 class="text-4xl lg:text-5xl text-center font-heading mb-12 text-yellow-600">Error 419</h3>
                  <div class="max-w-md mx-auto text-center text-white relative z-10">
                    ...
                    <a class="inline-block px-8 py-3 text-white font-bold bg-black hover:bg-gray-900" href="#">Go back to Homapage</a>
                  </div>
                </div>
              </section>
@endsection
